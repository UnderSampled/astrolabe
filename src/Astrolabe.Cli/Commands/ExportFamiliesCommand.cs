...
public static class ExportFamiliesCommand
{
    public static int Run(string[] args)
    {
        ...
        try
        {
            ...
            if (gpt.SpawnablePersosCount > 0 && gpt.SpawnablePersosHead != 0)
            {
                Console.WriteLine($"Checking {gpt.SpawnablePersosCount} spawnable persos...");
                var spawnablePersos = familyReader.FindSpawnablePersos(gpt.SpawnablePersosHead, gpt.SpawnablePersosCount);
